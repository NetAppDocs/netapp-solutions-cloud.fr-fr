...
La figure suivante, référencée à partir du https://cloud.google.com/architecture/partners/netapp-cloud-volumes/architecture?hl=en_US["section architecture"^] de la documentation Google Cloud NetApp Volumes , montre une vue de haut niveau.
