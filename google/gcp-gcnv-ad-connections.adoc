...
Le https://docs.cloud.google.com/netapp/volumes/docs/configure-and-use/active-directory/about-ad["Détails de connexion Active Directory"^] guide fournit des instructions aux administrateurs pour fournir des informations spécifiques sur le schéma Active Directory pour le placement des comptes machines, telles que les suivantes :
...
Pour activer le chiffrement AES pour NFS Kerberos, https://docs.cloud.google.com/netapp/volumes/docs/plan-and-prepare/security-considerations["voir la documentation de Google Cloud NetApp Volumes"^].
