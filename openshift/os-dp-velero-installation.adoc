...
image:redhat-openshift-oadp-install-006.png["Créer un secret pour les informations d'identification de l'utilisateur Storage Grid S3 à l'aide de l'interface de ligne de commande"]
