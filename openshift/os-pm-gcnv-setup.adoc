...
* Utilisez un Helm chart pour installer Trident sur les clusters OSD. Consultez link:https://docs.netapp.com/us-en/trident/trident-get-started/kubernetes-deploy-helm.html["ici"] pour obtenir des instructions sur l'installation du Helm chart.
